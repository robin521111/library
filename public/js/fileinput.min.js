  ...
  e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, String.prototype.setTokens = function (e) {
    var i,
      ...
      var t,
          ...
          d = i.hasBlobSupport(),
          c = (d || s) && window.atob && window.ArrayBuffer && window.Uint8Array;if (!c) return null;for (t = e.split(",")[0].indexOf("base64") >= 0 ? atob(e.split(",")[1]) : decodeURIComponent(e.split(",")[1]), a = new ArrayBuffer(t.length), r = new Uint8Array(a), n = 0; n < t.length; n += 1) {
        r[n] = t.charCodeAt(n);
      }return o = e.split(",")[0].split(":")[1].split(";")[0], d ? new Blob([i.hasArrayBufferViewSupport() ? r : a], { type: o }) : (l = new s(), l.append(a), l.getBlob(o));
      ...
      var t,
          ...
          n = new DataView(e),
          o = 0,
          l = 1;if (65496 !== n.getUint16(o) || e.length < 2) return void (i && i());for (o += 2, t = n.byteLength; t - 2 > o;) {
        switch (a = n.getUint16(o), o += 2, a) {case 65505:
            r = n.getUint16(o), t = r - o, o += 2;break;case 274:
            l = n.getUint16(o + 6, !1), t = 0;}
      }i && i(l);
      ...
      if (window.FileReader && window.DataView) {
        var a,
          ...
          a = r.result, i.setOrientation(a, t);
        }, r.readAsArrayBuffer(e);
      }
    }, adjustOrientedImage: function adjustOrientedImage(e, i) {
      var t, a, r;if (e.hasClass("is-portrait-gt4")) {
        if (i) return void e.css({ width: e.parent().height() });e.css({ height: "auto", width: e.height() }), t = e.parent().offset().top, a = e.offset().top, r = t - a, e.css("margin-top", r);
      }
    } }, t = function t(_t, a) {
    var r = this;r.$element = e(_t), r._validate() && (r.isPreviewable = i.hasFileAPISupport(), r.isIE9 = i.isIE(9), r.isIE10 = i.isIE(10), r.isPreviewable || r.isIE9 ? (r._init(a), r._listen()) : r.$element.removeClass("file-loading"));
      ...
      var t = this;t.previewCache = { data: {}, init: function init() {
          ...
          var n = t.previewCache.data;if (!n || !n.config || 0 === n.config.length || i.isEmpty(n.config[e])) return "";a = void 0 === a ? !0 : a;var o,
              l = n.config[e],
              s = i.ifSet("caption", l),
              ...
              h = i.ifSet("showZoom", l, i.ifSet("showZoom", p, !0)),
              v = i.ifSet("showDrag", l, i.ifSet("showDrag", p, !0)),
              g = c === !1 && a;return o = t._renderFileActions(!1, m, h, v, g, c, u, !0), t._getLayoutTemplate("footer").setTokens({ progress: t._renderThumbProgress(), actions: o, caption: s, size: t._getSize(r), width: d, indicator: "" });
        } }, t.previewCache.init();
      ...
      };r(a.code === a.NOT_FOUND_ERR ? t.msgFileNotFound : a.code === a.SECURITY_ERR ? t.msgFileSecured : a.code === a.NOT_READABLE_ERR ? t.msgFileNotReadable : a.code === a.ABORT_ERR ? t.msgFilePreviewAborted : t.msgFilePreviewError);
      ...
      var t,
          a = this,
          r = a.$errorContainer;e && (t = a.msgFoldersNotAllowed.replace("{n}", e), a._addError(t), i.addCss(a.$container, "has-error"), r.fadeIn(800), a._raise("filefoldererror", [e, t]));
      ...
      var t,
          a = this,
          r = null;return i && i.indexOf(".") > -1 && (t = i.split(".").pop(), a.previewFileIconSettings && (r = a.previewFileIconSettings[t] || a.previewFileIconSettings[t.toLowerCase()] || null), a.previewFileExtSettings && e.each(a.previewFileExtSettings, function (e, i) {
      ...
      var t = this,
          ...
          r = e;return r.indexOf("{previewFileIcon}") > -1 && (r = r.setTokens({ previewFileIconClass: t.previewFileIconClass, previewFileIcon: a })), r;
      ...
      var t = this,
          a = t.$preview,
          r = t.showUploadedThumbs ? t.getFrames(":not(.file-preview-success)") : t.getFrames();r.each(function () {
      ...
      var t,
          a = this,
          r = a.$preview,
          n = "." + i.SORT_CSS;window.KvSortable && 0 !== r.find(n).length && (t = { handle: ".drag-handle-init", dataIdAttr: "data-preview-id", scroll: !1, draggable: n, onSort: function onSort(t) {
          var r,
              n,
              o = t.oldIndex,
            ...
            null !== a.initialPreviewConfig[s] && (r = a.initialPreviewConfig[s].key, n = e(".kv-file-remove[data-key='" + r + "']").closest(i.FRAMES), n.attr("data-fileindex", "init_" + s).attr("data-fileindex", "init_" + s));
      ...
      var i,
          ...
          s = a.$modal.find(".btn-next");return n.length < 2 ? (l.hide(), void s.hide()) : (l.show(), s.show(), void (o && (i = e(n[0]), t = e(n[o - 1]), l.removeAttr("disabled"), s.removeAttr("disabled"), i.length && i.attr("id") === r && l.attr("disabled", !0), t.length && t.attr("id") === r && s.attr("disabled", !0))));
      ...
      var r,
      ...
      })), v.data("previewId", h);var T = s.find("img");T.length && i.adjustOrientedImage(T, !0), m._handler(g, "click", function () {
        m._zoomSlideShow("prev", h);
      }), m._handler(w, "click", function () {
        m._zoomSlideShow("next", h);
        ...
        var i = e.which || e.keyCode;37 !== i || g.attr("disabled") || m._zoomSlideShow("prev", h), 39 !== i || w.attr("disabled") || m._zoomSlideShow("next", h);
      });
      ...
      var a,
        ...
        for (r = 0; d > r; r++) {
          if (e(s[r]).attr("id") === t) {
            n = "prev" === i ? r - 1 : r + 1;break;
          }
        }0 > n || n >= d || !s[n] || (a = e(s[n]), a.length && o._setZoomContent(a, !0), o._initZoomButtons(), o._raise("filezoom" + i, { previewId: t, modal: o.$modal }));
      }
      ...
      var l,
        ...
        }, url: o && s.uploadUrlThumb ? s.uploadUrlThumb : s.uploadUrl, type: "POST", dataType: "json", data: s.formdata, cache: !1, processData: !1, contentType: !1, beforeSend: i, success: t, complete: a, error: r }, s.ajaxSettings), s.ajaxRequests.push(e.ajax(l)));
      ...
      var t = this;t.showPreview && t._getThumbs(i.FRAMES + ".file-preview-success").each(function () {
        var a = e(this),
          ...
          var e = a.attr("id"),
              n = t._raise("filesuccessremove", [e, a.attr("data-fileindex")]);i.cleanMemory(a), n !== !1 && a.fadeOut("slow", function () {
            i.cleanZoomCache(r.find("#zoom-" + e)), a.remove(), t.getFrames().length || t.reset();
          });
        });
      });
      ...
      var r,
          ...
          m,
          h = this,
          v = h.getFileStack().length,
          g = new FormData(),
          w = h.previewInitId + "-" + t,
          _ = h.filestack.length > 0 || !e.isEmptyObject(h.uploadExtraData),
          b = e("#" + w).find(".file-thumb-progress"),
          C = { id: w, index: t };h.formdata = g, h.showPreview && (n = e("#" + w + ":not(.file-preview-initial)"), l = n.find(".kv-file-upload"), s = n.find(".kv-file-remove"), b.removeClass("hide")), 0 === v || !_ || l && l.hasClass("disabled") || h._abort(C) || (m = function m(e, i) {
        d || h.updateStack(e, void 0), h.uploadLog.push(i), h._checkAsyncComplete() && (h.fileBatchCompleted = !0);
      }, o = function o() {
        var e,
            t,
            a,
            r = h.uploadCache,
            n = 0,
            o = h.cacheInitialPreview;h.fileBatchCompleted && (o && o.content && (n = o.content.length), setTimeout(function () {
          var l = 0 === h.getFileStack(!0).length;if (h.showPreview) {
            if (h.previewCache.set(r.content, r.config, r.tags, r.append), n) {
            ...
            } else h.initialPreview = r.content, h.initialPreviewConfig = r.config, h.initialPreviewThumbTags = r.tags;h.cacheInitialPreview = {}, h.hasInitData && (h._initPreview(), h._initPreviewActions());
        ...
        r = h._getOutData(o), h.fileBatchCompleted = !1, h.showPreview && (n.hasClass("file-preview-success") || (h._setThumbStatus(n, "Loading"), i.addCss(n, "file-uploading")), l.attr("disabled", !0), s.attr("disabled", !0)), a || h.lock(), h._raise("filepreupload", [r, w, t]), e.extend(!0, C, r), h._abort(C) && (o.abort(), h._setProgressCancelled());
      }, u = function u(o, s, c) {
        var u = h.showPreview && n.attr("id") ? n.attr("id") : w;r = h._getOutData(c, o), e.extend(!0, C, r), setTimeout(function () {
          i.isEmpty(o) || i.isEmpty(o.error) ? (h.showPreview && (h._setThumbStatus(n, "Success"), l.hide(), h._initUploadSuccess(o, n, a), h._setProgress(101, b)), h._raise("fileuploaded", [r, u, t]), a ? m(t, u) : h.updateStack(t, void 0)) : (d = !0, h._showUploadError(o.error, C), h._setPreviewError(n, t, h.filestack[t], h.retryErrorUploads), h.retryErrorUploads || l.hide(), a && m(t, u), h._setProgress(101, e("#" + u).find(".file-thumb-progress"), h.msgUploadError));
        }, 100);
      }, p = function p() {
        setTimeout(function () {
          h.showPreview && (l.removeAttr("disabled"), s.removeAttr("disabled"), n.removeClass("file-uploading")), a ? o() : (h.unlock(!1), h._clearFileInput()), h._initSuccessThumbs();
        }, 100);
      }, f = function f(i, r, o) {
        var s = h.ajaxOperations.uploadThumb,
            c = h._parseError(s, i, o, a && h.filestack[t].name ? h.filestack[t].name : null);d = !0, setTimeout(function () {
          a && m(t, w), h.uploadStatus[w] = 100, h._setPreviewError(n, t, h.filestack[t], h.retryErrorUploads), h.retryErrorUploads || l.hide(), e.extend(!0, C, h._getOutData(i)), h._setProgress(101, b, h.msgAjaxProgressError.replace("{operation}", s)), h._setProgress(101, e("#" + w).find(".file-thumb-progress"), h.msgUploadError), h._showUploadError(c, C);
        }, 100);
      }, g.append(h.uploadFileAttr, h.filestack[t], h.filenames[t]), g.append("file_id", t), h._ajaxSubmit(c, u, p, f, w, t));
      ...
      var t,
        ...
        var n = l._getOutData(r, t),
            ...
            c = i.isEmpty(t) || i.isEmpty(t.errorkeys) ? [] : t.errorkeys;i.isEmpty(t) || i.isEmpty(t.error) ? (l._raise("filebatchuploadsuccess", [n]), o(), l.showPreview ? (d.each(function () {
          var i = e(this);l._setThumbStatus(i, "Success"), i.removeClass("file-uploading"), i.find(".kv-file-upload").hide().removeAttr("disabled");
        }), l._initUploadSuccess(t)) : l.reset(), l._setProgress(101)) : (l.showPreview && (d.each(function () {
          var i = e(this),
              t = i.attr("data-fileindex");i.removeClass("file-uploading"), i.find(".kv-file-upload").removeAttr("disabled"), i.find(".kv-file-remove").removeAttr("disabled"), 0 === c.length || -1 !== e.inArray(s, c) ? (l._setPreviewError(i, t, l.filestack[t], l.retryErrorUploads), l.retryErrorUploads || (i.find(".kv-file-upload").hide(), l.updateStack(t, void 0))) : (i.find(".kv-file-upload").hide(), l._setThumbStatus(i, "Success"), l.updateStack(t, void 0)), i.hasClass("file-preview-error") && !l.retryErrorUploads || s++;
        }), l._initUploadSuccess(t)), l._showUploadError(t.error, n, "filebatchuploaderror"), l._setProgress(101, l.$progress, l.msgUploadError));
      }, n = function n() {
      ...
      var a = this,
          r = t.attr("data-fileindex");"init_" === r.substring(0, 5) && (r = parseInt(r.replace("init_", "")), a.initialPreview = i.spliceArray(a.initialPreview, r), a.initialPreviewConfig = i.spliceArray(a.initialPreviewConfig, r), a.initialPreviewThumbTags = i.spliceArray(a.initialPreviewThumbTags, r), a.getFrames().each(function () {
        var i = e(this),
      ...
      var t = this,
        ...
        var r,
          ...
          return l = t._raise("filepreremove", [c, u]), l !== !1 && t._validateMinCount() ? (r = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow", function () {
            i.cleanZoomCache(a.find("#zoom-" + c)), t.updateStack(u, void 0), t._clearObjects(d), d.remove(), c && r && t.$errorContainer.find('li[data-file-id="' + c + '"]').fadeOut("fast", function () {
              e(this).remove(), t._errorsExist() || t._resetErrors();
            }), t._clearFileInput();var l = t.getFileStack(!0),
                s = t.previewCache.count(),
                p = l.length,
                f = t.showPreview && t.getFrames().length;0 !== p || 0 !== s || f ? (n = s + p, o = n > 1 ? t._getMsgSelected(n) : l[0] ? t._getFileNames()[0] : "", t._setCaption(o)) : t.reset(), t._raise("fileremoved", [c, u]);
          })) : !1;
        });
      }), t.getFrames(" .kv-file-upload").each(function () {
        var a = e(this);t._handler(a, "click", function () {
          var e = a.closest(i.FRAMES),
              r = e.attr("data-fileindex");t.$progress.addClass("hide"), e.hasClass("file-preview-error") && !t.retryErrorUploads || t._uploadSingle(r, !1);
        });
      }));
      ...
      var t = this,
        ...
        var n = e(this),
          ...
          var d,
              ...
              h = f.attr("data-fileindex");h = parseInt(h.replace("init_", "")), u = i.isEmpty(m.config) && i.isEmpty(m.config[h]) ? null : m.config[h], p = i.isEmpty(u) || i.isEmpty(u.extra) ? r : u.extra, "function" == typeof p && (p = p()), c = { id: n.attr("id"), key: s, extra: p }, d = e.extend(!0, {}, { url: l, type: "POST", dataType: "json", data: e.extend(!0, {}, { key: s }, p), beforeSend: function beforeSend(e) {
              t.ajaxAborted = !1, t._raise("filepredelete", [s, e, p]), t._abort() ? e.abort() : (i.addCss(f, "file-uploading"), i.addCss(n, "disabled"));
            }, success: function success(e, r, l) {
              var d, u;return i.isEmpty(e) || i.isEmpty(e.error) ? (h = parseInt(f.attr("data-fileindex").replace("init_", "")), t.previewCache.unset(h), d = t.previewCache.count(), u = d > 0 ? t._getMsgSelected(d) : "", t._deleteFileIndex(f), t._setCaption(u), t._raise("filedeleted", [s, l, p]), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function () {
    ...
    }, _generatePreviewTemplate: function _generatePreviewTemplate(t, a, r, n, o, l, s, d, c, u, p) {
      var f,
          m = this,
          h = m.slug(r),
          v = "",
          ...
          b = c || m._renderFileFooter(h, s, i.isEmpty(w) ? "auto" : w, l),
        ...
        var f = s ? "zoom-" + o : o,
            ...
            g = (d || "") + " " + c;return m.frameClass && (g = m.frameClass + " " + g), s && (g = g.replace(" " + i.SORT_CSS, "")), v = m._parseFilePreviewIcon(v, r), "text" === a && (l = i.htmlEncode(l)), "object" !== t || n || e.each(m.defaults.fileTypeSettings, function (e, i) {
          "object" !== e && "other" !== e && i(r, n) && (y = "type-" + e);
        }), v.setTokens({ previewId: f, caption: h, frameClass: g, type: n, fileindex: u, width: w, height: _, typeCss: y, footer: b, data: l, template: p || t });
      };return u = u || o.slice(o.lastIndexOf("-") + 1), m.fileActionSettings.showZoom && (v = x(E ? "other" : t, a, !0, "kv-zoom-thumb")), v = "\n" + m._getLayoutTemplate("zoomCache").replace("{zoomContent}", v), f = x(T ? "other" : t, a, !1, "kv-preview-thumb"), f + v;
      ...
      var n = this,
        ...
        var l,
            ...
            c = t.size || 0,
            u = n.slug(s),
            p = r === !0 && !n.isUploadable,
            f = i.objUrl.createObjectURL(t);n._clearDefaultPreview(), l = n._generatePreviewTemplate("other", f, s, d, a, p, c), o.append("\n" + l), n._setThumbAttr(a, u, c), r === !0 && n.isUploadable && n._setThumbStatus(e("#" + a), "Error");
      }
    }, _previewFile: function _previewFile(e, t, a, r, n) {
      if (this.showPreview) {
        var o,
            l = this,
            ...
            h = t.size || 0,
            v = t.type,
            g = "text" === s || "html" === s || "image" === s ? a.target.result : n,
            w = p && -1 !== p.indexOf(v);if ("html" === s && l.purifyHtml && window.DOMPurify && (g = window.DOMPurify.sanitize(g)), m || w) {
          o = l._generatePreviewTemplate(s, g, d, v, r, !1, h), l._clearDefaultPreview(), f.append("\n" + o);var _ = f.find("#" + r + " img");_.length && l.autoOrientImage ? i.validateOrientation(t, function (e) {
            if (!e) return void l._validateImage(r, c, v, h, g);var a = f.find("#zoom-" + r + " img"),
                n = "rotate-" + e;e > 4 && (n += _.width() > _.height() ? " is-portrait-gt4" : " is-landscape-gt4"), i.addCss(_, n), i.addCss(a, n), l._raise("fileimageoriented", { $img: _, file: t }), l._validateImage(r, c, v, h, g), i.adjustOrientedImage(_);
          }) : l._validateImage(r, c, v, h, g);
        } else l._previewDefault(t, r);l._setThumbAttr(r, c, h), l._initSortable();
      }
      ...
      this.reader = new FileReader();var _a2,
        ...
        if (i.isEmpty(n.attr("multiple")) && (f = 1), e >= f) return r.isUploadable && r.filestack.length > 0 ? r._raise("filebatchselected", [r.getFileStack()]) : r._raise("filebatchselected", [t]), s.removeClass("file-thumb-loading"), void d.html("");var T,
            E,
            x,
            S,
            F,
            ...
            D = p + "-" + $,
            U = t[e],
            B = U.name ? r.slug(U.name) : "",
            j = (U.size || 0) / 1e3,
            R = "",
            L = i.objUrl.createObjectURL(U),
            O = 0,
            Z = "";if (g > 0) for (S = 0; g > S; S++) {
          P = v[S], z = r.msgFileTypes[P] || P, Z += 0 === S ? z : ", " + z;
        }if (B === !1) return void _a2(e + 1);if (0 === B.length) return F = r.msgInvalidFileName.replace("{name}", i.htmlEncode(U.name)), void (r.isError = y(F, U, D, e));if (i.isEmpty(w) || (R = new RegExp("\\.(" + w.join("|") + ")$", "i")), x = j.toFixed(2), r.maxFileSize > 0 && j > r.maxFileSize) return F = r.msgSizeTooLarge.setTokens({ name: B, size: x, maxSize: r.maxFileSize }), void (r.isError = y(F, U, D, e));if (null !== r.minFileSize && j <= i.getNum(r.minFileSize)) return F = r.msgSizeTooSmall.setTokens({ name: B, size: x, minSize: r.minFileSize }), void (r.isError = y(F, U, D, e));if (!i.isEmpty(v) && i.isArray(v)) {
          for (S = 0; S < v.length; S += 1) {
            I = v[S], A = m[I], O += A && "function" == typeof A && A(U.type, U.name) ? 1 : 0;
          }if (0 === O) return F = r.msgInvalidFileType.setTokens({ name: B, types: Z }), void (r.isError = y(F, U, D, e));
          ...
          F = u.setTokens({ index: e + 1, files: f, percent: 50, name: B }), setTimeout(function () {
          ...
          if (i.lengthComputable) {
            var t = i.loaded / i.total * 100,
                a = Math.ceil(t);F = u.setTokens({ index: e + 1, files: f, percent: a, name: B }), setTimeout(function () {
              d.html(F);
            }, 100);
          }
        }, T = m.text, E = m.image, T(U.type, B) ? l.readAsText(U, r.textEncoding) : E(U.type, B) ? l.readAsDataURL(U) : l.readAsArrayBuffer(U)) : (r._previewDefault(U, D), setTimeout(function () {
          _a2(e + 1), r._updateFileDetails(f);
        }, 100), r._raise("fileloaded", [U, D, e, l])), void r.addToStack(U)) : (r.isUploadable && r.addToStack(U), setTimeout(function () {
          _a2(e + 1), r._updateFileDetails(f);
        }, 100), void r._raise("fileloaded", [U, D, e, l])) : (F = r.msgInvalidFileExtension.setTokens({ name: B, extensions: _ }), void (r.isError = y(F, U, D, e)));
      ...
      var t = this;if (t.showPreview) {
        var a = "indicator" + i,
            ...
            l = t.fileActionSettings;e.removeClass("file-preview-success file-preview-error file-preview-loading"), "Success" === i && (e.find(".file-drag-handle").remove(), o.css("margin-left", 0)), o.html(l[a]), o.attr("title", l[r]), e.addClass(n), "Error" !== i || t.retryErrorUploads || e.find(".kv-file-upload").attr("disabled", !0);
      }
      ...
      var r,
          ...
          d = 100 > o ? n.progressTemplate : a ? n.progressErrorTemplate : s;t = t || n.$progress, i.isEmpty(d) || (r = l && o > l && 100 >= e ? d.setTokens({ percent: l, status: n.msgUploadThreshold }) : d.setTokens({ percent: o, status: e > 100 ? n.msgUploadEnd : o + "%" }), t.html(r), a && t.find('[role="progressbar"]').html(a));
    ...
    }, _setPreviewError: function _setPreviewError(e, i, t, a) {
      var r = this;void 0 !== i && r.updateStack(i, t), r.removeFromPreviewOnError && !a ? e.remove() : r._setThumbStatus(e, "Error"), r._refreshUploadButton(e, a);
    }, _refreshUploadButton: function _refreshUploadButton(e, i) {
      var t = this,
          a = e.find(".kv-file-upload"),
          r = t.fileActionSettings,
          n = r.uploadIcon,
          o = r.uploadTitle;a.length && (i && (n = r.uploadRetryIcon, o = r.uploadRetryTitle), a.attr("title", o).html(n));
      ...
      var s,
          ...
          p = this,
          f = "Small" === t ? "min" : "max",
          m = p[f + "Image" + o];!i.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === t ? d >= m : m >= d, u || (s = p["msgImage" + o + t].setTokens({ name: n, size: m }), p._showUploadError(s, l), p._setPreviewError(r, e, null)));
    }, _validateImage: function _validateImage(i, t, a, r, n) {
      var o,
          l,
          s,
          d,
        ...
        l = p.width(), s = u.width(), l > s && m.css("width", "100%"), o = { ind: f, id: i }, c._checkDimensions(f, "Small", m, p, t, "Width", o), c._checkDimensions(f, "Small", m, p, t, "Height", o), c.resizeImage || (c._checkDimensions(f, "Large", m, p, t, "Width", o), c._checkDimensions(f, "Large", m, p, t, "Height", o)), c._raise("fileimageloaded", [i]), d = window.piexif ? window.piexif.load(n) : null, c.loadedImages.push({ ind: f, img: m, thumb: p, pid: i, typ: a, siz: r, validated: !1, imgData: n, exifObj: d }), p.data("exif", d), c._validateAllImages();
      }).one("error", function () {
      ...
      var e,
        ...
        i = a.loadedImages[e], i.validated || (t = i.siz, t && t > 1e3 * o && a._getResizedImage(i, r, n), a.loadedImages[e].validated = !0);
      }
    }, _getResizedImage: function _getResizedImage(t, a, r) {
      var n,
          o,
          l,
          s,
          ...
          E = t.ind,
          x = t.thumb,
          S = t.exifObj;if (d = function d(e, i, t) {
        p.isUploadable ? p._showUploadError(e, i, t) : p._showError(e, i, t), p._setPreviewError(x, E);
      }, (!p.filestack[E] || !_ || g >= m && w >= h) && (_ && p.filestack[E] && p._raise("fileimageresized", [T, E]), a.val++, a.val === r && p._raise("fileimagesresized"), !_)) return void d(p.msgImageResizeError, { id: T, index: E }, "fileimageresizeerror");
      y = y || p.resizeDefaultImageType, o = m > g, l = h > w, v = "width" === p.resizePreference ? o ? g / m : l ? w / h : 1 : l ? w / h : o ? g / m : 1, p._resetCanvas(), m *= v, h *= v, b.width = m, b.height = h;try {
        C.drawImage(f, 0, 0, m, h), s = b.toDataURL(y, p.resizeQuality), S && (u = window.piexif.dump(S), s = window.piexif.insert(u, s)), n = i.dataURI2Blob(s), p.filestack[E] = n, p._raise("fileimageresized", [T, E]), a.val++, a.val === r && p._raise("fileimagesresized", [void 0, void 0]), n instanceof Blob || d(p.msgImageResizeError, { id: T, index: E }, "fileimageresizeerror");
      } catch (F) {
        a.val++, a.val === r && p._raise("fileimagesresized", [void 0, void 0]), c = p.msgImageResizeException.replace("{errors}", F.message), d(c, { id: T, index: E }, "fileimageresizeexception");
      }
      ...
      var e = this,
          ...
          n = e.captionTemplate.setTokens({ "class": r + " kv-fileinput-caption" });return e.mainTemplate.setTokens({ "class": e.mainClass + (!e.showBrowse && e.showCaption ? " no-browse" : ""), preview: a, close: t, caption: n, upload: e._renderButton("upload"), remove: e._renderButton("remove"), cancel: e._renderButton("cancel"), browse: e._renderButton("browse") });
      ...
      var t = this,
          ...
          return "";}return r += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", i.isEmpty(l) || (l = ' <span class="' + t.buttonLabelClass + '">' + l + "</span>"), a.setTokens({ type: d, css: r, title: n, status: s, icon: o, label: l });
      ...
      var n,
          ...
          h = r ? l.indicatorErrorTitle : l.indicatorNewTitle,
          v = m.setTokens({ indicator: f, indicatorTitle: h });return t = o._getSize(t), n = o.isUploadable ? p.setTokens({ actions: o._renderFileActions(c, s, u, d, !1, !1, !1), caption: e, size: t, width: a, progress: o._renderThumbProgress(), indicator: v }) : p.setTokens({ actions: o._renderFileActions(!1, !1, u, d, !1, !1, !1), caption: e, size: t, width: a, progress: "", indicator: v }), n = i.replaceTags(n, o.previewThumbTags);
      ...
      var a = this,
          ...
          u = a.isUploadable,
          p = c ? t.originalEvent.dataTransfer.files : r.get(0).files,
        ...
        var o = e.extend(!0, {}, a._getOutData({}, {}, p), { id: r, index: n }),
            l = { id: r, index: n, file: t, files: p };return a.isUploadable ? a._showUploadError(i, o) : a._showError(i, l);
        ...
        i && !i.type && void 0 !== i.size && i.size % 4096 === 0 ? v++ : a._filterDuplicate(i, d, g);
      ...
      }) : d = p), i.isEmpty(d) || 0 === d.length) return u || a.clear(), a._showFolderError(v), void a._raise("fileselectnone");if (a._resetErrors(), s = d.length, o = a._getFileCount(a.isUploadable ? a.getFileStack().length + s : s), a.maxFileCount > 0 && o > a.maxFileCount) {
      ...
      } else !u || h ? (a._resetPreviewThumbs(!1), h && a.clearStack()) : !u || 0 !== f || a.previewCache.count() && !a.overwriteInitial || a._resetPreviewThumbs(!0);a.isPreviewable ? a._readFiles(d) : a._updateFileDetails(1), a._showFolderError(v);
      ...
      var t = this,
        ...
        var l,
            ...
            c = t.filestack[d],
            u = s.attr("id");"-1" !== d && -1 !== d && (void 0 !== c ? (r[a] = c, n[a] = t._getFileName(c), o[a] = t._getFileId(c), s.attr({ id: t.previewInitId + "-" + a, "data-fileindex": a }), a++) : (l = "uploaded-" + i.uniqId(), s.attr({ id: l, "data-fileindex": "-1" }), t.$preview.find("#zoom-" + u).attr("id", "zoom-" + l)));
      ...
      var t,
          ...
          l = !e.isEmptyObject(n._getExtraData());if (n.isUploadable && !n.isDisabled && n._isFileSelectionValid(o)) {
        if (n._resetUpload(), 0 === o && !l) return void n._showUploadError(n.msgUploadEmpty);if (n.$progress.removeClass("hide"), n.uploadCount = 0, n.uploadStatus = {}, n.uploadLog = [], n.lock(), n._setProgress(2), 0 === o && l) return void n._uploadExtraOnly();if (r = n.filestack.length, n.hasInitData = !1, !n.uploadAsync) return n._uploadBatch(), n.$element;for (a = n._getOutData(), n._raise("filebatchpreupload", [a]), n.fileBatchCompleted = !1, n.uploadCache = { content: [], config: [], tags: [], append: !0 }, n.uploadAsyncCount = n.getFileStack().length, t = 0; r > t; t++) {
          ...
          n.filestack[t] && n._uploadSingle(t, !0);
        }
      }
      ...
      var i = this,
          ...
          a = i.$container,
          r = i.$element,
          n = i.namespace;return e(document).off(n), e(window).off(n), t && t.length && t.off(n), i.isUploadable && i._clearFileInput(), i._cleanup(), i._initPreviewCache(), r.insertBefore(a).off(n).removeData(), a.off().remove(), r;
      ...
      var t = this,
          a = t._getFrame(e),
          r = t.$modal;a && (i.initModal(r), r.html(t._getModalContent()), t._setZoomContent(a), r.modal("show"), t._initZoomButtons());
