 ...
 */!function (e) {
  ...
  e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, String.prototype.setTokens = function (e) {
    var t,
    ...
    }, spliceArray: function spliceArray(e, t) {
      var i,
          a = 0,
          n = [];if (!(e instanceof Array)) return [];for (i = 0; i < e.length; i++) {
        i !== t && (n[a] = e[i], a++);
      }return n;
      ...
      var i,
          ...
          d = t.hasBlobSupport(),
          c = (d || s) && window.atob && window.ArrayBuffer && window.Uint8Array;if (!c) return null;for (i = e.split(",")[0].indexOf("base64") >= 0 ? atob(e.split(",")[1]) : decodeURIComponent(e.split(",")[1]), a = new ArrayBuffer(i.length), n = new Uint8Array(a), r = 0; r < i.length; r += 1) {
        n[r] = i.charCodeAt(r);
    ...
    }, getElement: function getElement(i, a, n) {
    ...
    }, moveArray: function moveArray(e, t, i) {
      ...
      var i,
          ...
          r = new DataView(e),
          o = 0,
          l = 1;if (65496 !== r.getUint16(o) || e.length < 2) return void (t && t());for (o += 2, i = r.byteLength; i - 2 > o;) {
        switch (a = r.getUint16(o), o += 2, a) {case 65505:
            n = r.getUint16(o), i = n - o, o += 2;break;case 274:
      ...
      var i, a, n;if (e.hasClass("is-portrait-gt4")) {
        if (t) return void e.css({ width: e.parent().height() });e.css({ height: "auto", width: e.height() }), i = e.parent().offset().top, a = e.offset().top, n = i - a, e.css("margin-top", n);
      }
    } }, i = function i(_i, a) {
    var n = this;n.$element = e(_i), n.$parent = n.$element.parent(), n._validate() && (n.isPreviewable = t.hasFileAPISupport(), n.isIE9 = t.isIE(9), n.isIE10 = t.isIE(10), (n.isPreviewable || n.isIE9) && (n._init(a), n._listen()), n.$element.removeClass("file-loading"));
      ...
      var n,
          ...
          o,
          l = this,
          s = l.$element;l.options = i, e.each(i, function (e, i) {
      ...
      var i = this;i.previewCache = { data: {}, init: function init() {
          ...
          var o,
            ...
            } else s.content = e, s.config = a, s.tags = n;i.previewCache.data = s;
          }
        }, unset: function unset(e) {
          var t = i.previewCache.count();if (t) {
            if (1 === t) return i.previewCache.data.content = [], i.previewCache.data.config = [], i.previewCache.data.tags = [], i.initialPreview = [], i.initialPreviewConfig = [], void (i.initialPreviewThumbTags = []);i.previewCache.data.content.splice(e, 1), i.previewCache.data.config.splice(e, 1), i.previewCache.data.tags.splice(e, 1);
          }
        }, out: function out() {
          var e,
              t,
          ...
          var r = i.previewCache.data;if (!r || !r.config || 0 === r.config.length || t.isEmpty(r.config[e])) return "";a = void 0 === a ? !0 : a;var o,
              l = r.config[e],
              s = t.ifSet("caption", l),
              ...
              C = c === !1 && a;return w = w && l.downloadUrl !== !1 && !!m, o = i._renderFileActions(!1, w, h, _, b, C, c, u, !0, m, v), i._getLayoutTemplate("footer").setTokens({ progress: i._renderThumbProgress(), actions: o, caption: s, size: i._getSize(n), width: d, indicator: "" });
        } }, i.previewCache.init();
      ...
      var i,
          a = this,
          n = a.$errorContainer;e && (i = a.msgFoldersNotAllowed.replace("{n}", e), a._addError(i), t.addCss(a.$container, "has-error"), n.fadeIn(800), a._raise("filefoldererror", [e, i]));
    }, _showUploadError: function _showUploadError(e, i, a) {
      var n = this,
          r = n.$errorContainer,
          o = a || "fileuploaderror",
          l = i && i.id ? '<li data-file-id="' + i.id + '">' + e + "</li>" : "<li>" + e + "</li>";return 0 === r.find("ul").length ? n._addError("<ul>" + l + "</ul>") : r.find("ul").append(l), r.fadeIn(800), n._raise(o, [i, e]), n.$container.removeClass("file-input-new"), t.addCss(n.$container, "has-error"), !0;
    }, _showError: function _showError(e, i, a) {
      var n = this,
          r = n.$errorContainer,
          o = a || "fileerror";return i = i || {}, i.reader = n.reader, n._addError(e), r.fadeIn(800), n._raise(o, [i, e]), n.isUploadable || n._clearFileInput(), n.$container.removeClass("file-input-new"), t.addCss(n.$container, "has-error"), n.$btnUpload.attr("disabled", !0), !0;
    }, _noFilesError: function _noFilesError(e) {
      var i = this,
          a = i.minFileCount > 1 ? i.filePlural : i.fileSingle,
          n = i.msgFilesTooLess.replace("{n}", i.minFileCount).replace("{files}", a),
          r = i.$errorContainer;i._addError(n), i.isError = !0, i._updateFileDetails(0), r.fadeIn(800), i._raise("fileerror", [e, n]), i._clearFileInput(), t.addCss(i.$container, "has-error");
    }, _parseError: function _parseError(t, i, a, n) {
      var r,
          o = this,
          l = e.trim(a + ""),
      ...
      var i,
        ...
        if (n = l[r], i = o.fileTypeSettings[n], a = i(e.type, e.name) ? n : "", !t.isEmpty(a)) return a;
      }return "other";
    }, _getPreviewIcon: function _getPreviewIcon(t) {
      var i,
          a = this,
          n = null;return t && t.indexOf(".") > -1 && (i = t.split(".").pop(), a.previewFileIconSettings && (n = a.previewFileIconSettings[i] || a.previewFileIconSettings[i.toLowerCase()] || null), a.previewFileExtSettings && e.each(a.previewFileExtSettings, function (e, t) {
      ...
      var t,
          ...
          a = this,
          n = 400 > i ? a.previewSettingsSmall || a.defaults.previewSettingsSmall : a.previewSettings || a.defaults.previewSettings;e.each(n, function (e, i) {
      ...
      var i,
          a = this;a.isClickable && (i = a.isUploadable ? a.$dropZone : a.$preview.find(".file-default-preview"), t.addCss(i, "clickable"), i.attr("tabindex", -1), a._handler(i, "click", function (t) {
        var n = e(t.target);n.parents(".file-preview-thumbnails").length && !n.parents(".file-default-preview").length || (a.$element.trigger("click"), i.blur());
      }));
    }, _initDragDrop: function _initDragDrop() {
      var t = this,
          i = t.$dropZone;t.isUploadable && t.dropZoneEnabled && t.showPreview && (t._handler(i, "dragenter dragover", e.proxy(t._zoneDragEnter, t)), t._handler(i, "dragleave", e.proxy(t._zoneDragLeave, t)), t._handler(i, "drop", e.proxy(t._zoneDrop, t)), t._handler(e(document), "dragenter dragover drop", t._zoneDragDropInit));
      ...
      var i,
        ...
        if (!a.isUploadable) return void (r && "submit" !== n.attr("type") && (i = n.closest("form"), i.length && i.trigger("submit"), e.preventDefault()));e.preventDefault(), r && a.upload();
      }
      ...
      var i = this,
          a = i.$preview,
          n = i.showUploadedThumbs ? i.getFrames(":not(.file-preview-success)") : i.getFrames();n.each(function () {
      ...
      var i,
          a = this,
          n = a.$preview,
          r = "." + t.SORT_CSS;window.KvSortable && 0 !== n.find(r).length && (i = { handle: ".drag-handle-init", dataIdAttr: "data-preview-id", scroll: !1, draggable: r, onSort: function onSort(i) {
          var n,
              r,
              o = i.oldIndex,
              l = i.newIndex;a.initialPreview = t.moveArray(a.initialPreview, o, l), a.initialPreviewConfig = t.moveArray(a.initialPreviewConfig, o, l), a.previewCache.init();for (var s = 0; s < a.initialPreviewConfig.length; s++) {
            null !== a.initialPreviewConfig[s] && (n = a.initialPreviewConfig[s].key, r = e(".kv-file-remove[data-key='" + n + "']").closest(t.FRAMES), r.attr("data-fileindex", "init_" + s).attr("data-fileindex", "init_" + s));
          }a._raise("filesorted", { previewId: e(i.item).attr("id"), oldIndex: o, newIndex: l, stack: a.initialPreviewConfig });
      ...
      var i = this,
        ...
        var o = a.find(".btn-fullscreen"),
            l = a.find(".btn-borderless");i._raise("filezoom" + e, n(r)), "shown" === e && (l.removeClass("active").attr("aria-pressed", "false"), o.removeClass("active").attr("aria-pressed", "false"), a.hasClass("file-zoom-fullscreen") && (i._maximizeZoomDialog(), t.checkFullScreen() ? o.addClass("active").attr("aria-pressed", "true") : l.addClass("active").attr("aria-pressed", "true")));
      });
    }, _initZoom: function _initZoom() {
      var i,
          a = this,
          n = a._getLayoutTemplate("modalMain"),
          r = "#" + t.MODAL_ID;a.showPreview && (a.$modal = e(r), a.$modal && a.$modal.length || (i = e(document.createElement("div")).html(n).insertAfter(a.$container), a.$modal = e(r).insertBefore(i), i.remove()), t.initModal(a.$modal), a.$modal.html(a._getModalContent()), e.each(t.MODAL_EVENTS, function (e, t) {
      ...
      var a,
        ...
        }0 > r || r >= d || !s[r] || (a = e(s[r]), a.length && o._setZoomContent(a, !0), o._initZoomButtons(), o._raise("filezoom" + t, { previewId: i, modal: o.$modal }));
      }
      ...
      var a,
          n = this,
          r = n.ajaxSettings,
          o = n.mergeAjaxCallbacks;"delete" === i && (r = n.ajaxDeleteSettings, o = n.mergeAjaxDeleteCallbacks), a = r[e], o && "function" == typeof a ? "before" === o ? r[e] = function () {
    ...
    }, _ajaxSubmit: function _ajaxSubmit(t, i, a, n, r, o) {
      var l,
          s = this;s._raise("filepreajax", [r, o]) && (s._uploadExtra(r, o), s._mergeAjaxCallback("beforeSend", t), s._mergeAjaxCallback("success", i), s._mergeAjaxCallback("complete", a), s._mergeAjaxCallback("error", n), l = e.extend(!0, {}, { xhr: function xhr() {
    ...
    }, _initUploadSuccess: function _initUploadSuccess(i, a, n) {
      var r,
          o,
          l,
          s,
      ...
      var i = this;i.showPreview && i._getThumbs(t.FRAMES + ".file-preview-success").each(function () {
        var a = e(this),
            n = i.$preview,
            r = a.find(".kv-file-remove");r.removeAttr("disabled"), i._handler(r, "click", function () {
          var e = a.attr("id"),
              r = i._raise("filesuccessremove", [e, a.attr("data-fileindex")]);t.cleanMemory(a), r !== !1 && a.fadeOut("slow", function () {
      ...
      var n,
          ...
          C = { id: w, index: i };v.formdata = h, v.showPreview && (r = e("#" + w + ":not(.file-preview-initial)"), l = r.find(".kv-file-upload"), s = r.find(".kv-file-remove"), b.show()), 0 === g || !_ || l && l.hasClass("disabled") || v._abort(C) || (m = function m(e, t) {
          ...
          var l = 0 === v.getFileStack(!0).length;if (v.showPreview) {
            if (v.previewCache.set(n.content, n.config, n.tags, n.append), r) {
              for (i = 0; i < n.content.length; i++) {
                a = i + r, o.content[a] = n.content[i], o.config.length && (o.config[a] = n.config[i]), o.tags.length && (o.tags[a] = n.tags[i]);
        ...
        var u = v.showPreview && r.attr("id") ? r.attr("id") : w;n = v._getOutData(c, o), e.extend(!0, C, n), setTimeout(function () {
      ...
      var i,
        ...
        l.lock();var a = l._getOutData(_i2);l.showPreview && l._getThumbs().each(function () {
          var i = e(this),
        ...
        }), l._raise("filebatchpreupload", [a]), l._abort(a) && (_i2.abort(), l._setProgressCancelled());
      }, a = function a(i, _a, n) {
        var r = l._getOutData(n, i),
            s = 0,
            d = l._getThumbs(":not(.file-preview-success)"),
            c = t.isEmpty(i) || t.isEmpty(i.errorkeys) ? [] : i.errorkeys;t.isEmpty(i) || t.isEmpty(i.error) ? (l._raise("filebatchuploadsuccess", [r]), o(), l.showPreview ? (d.each(function () {
      ...
      var e,
        ...
        r.lock();var t = r._getOutData(_e);r._raise("filebatchpreupload", [t]), r._setProgress(50), o.data = t, o.xhr = _e, r._abort(o) && (_e.abort(), r._setProgressCancelled());
      }, i = function i(e, _i3, a) {
        var n = r._getOutData(a, e);t.isEmpty(e) || t.isEmpty(e.error) ? (r._raise("filebatchuploadsuccess", [n]), r._clearFileInput(), r._initUploadSuccess(e), r._setProgress(101)) : r._showUploadError(e.error, n, "filebatchuploaderror");
      }, a = function a() {
      ...
      var a = this,
          n = i.attr("data-fileindex");"init_" === n.substring(0, 5) && (n = parseInt(n.replace("init_", "")), a.initialPreview = t.spliceArray(a.initialPreview, n), a.initialPreviewConfig = t.spliceArray(a.initialPreviewConfig, n), a.initialPreviewThumbTags = t.spliceArray(a.initialPreviewThumbTags, n), a.getFrames().each(function () {
        var t = e(this),
            i = t.attr("data-fileindex");"init_" === i.substring(0, 5) && (i = parseInt(i.replace("init_", "")), i > n && (i--, t.attr("data-fileindex", "init_" + i)));
      ...
      var i = this,
        ...
        var n,
            ...
            c = d.attr("id"),
            u = d.attr("data-fileindex");i._handler(s, "click", function () {
          return l = i._raise("filepreremove", [c, u]), l !== !1 && i._validateMinCount() ? (n = d.hasClass("file-preview-error"), t.cleanMemory(d), void d.fadeOut("slow", function () {
            t.cleanZoomCache(a.find("#zoom-" + c)), i.updateStack(u, void 0), i._clearObjects(d), d.remove(), c && n && i.$errorContainer.find('li[data-file-id="' + c + '"]').fadeOut("fast", function () {
              e(this).remove(), i._errorsExist() || i._resetErrors();
                ...
                p = l.length,
                f = i.showPreview && i.getFrames().length;0 !== p || 0 !== s || f ? (r = s + p, o = r > 1 ? i._getMsgSelected(r) : l[0] ? i._getFileNames()[0] : "", i._setCaption(o)) : i.reset(), i._raise("fileremoved", [c, u]);
          })) : !1;
        });
      ...
      var i = this,
          ...
          d = function d() {
        var e = i.isUploadable ? i.previewCache.count() : i.$element.get(0).files.length;a.find(t.FRAMES).length || e || (i._setCaption(""), i.reset(), i.initialCaption = "");
        ...
        var r,
            ...
            f = u.data("key");u.closest(".file-preview-frame");if (!t.isEmpty(p) && void 0 !== f) {
          var m,
              v,
              g,
              h,
              ...
              b = w.attr("data-fileindex");b = parseInt(b.replace("init_", "")), g = t.isEmpty(_.config) && t.isEmpty(_.config[b]) ? null : _.config[b], h = t.isEmpty(g) || t.isEmpty(g.extra) ? n : g.extra, "function" == typeof h && (h = h()), v = { id: u.attr("id"), key: f, extra: h }, r = function r(e) {
            ...
            var n = i.ajaxOperations.deleteThumb,
                r = i._parseError(n, e, a);v.jqXHR = e, v.response = {}, i._showError(r, v, "filedeleteerror"), w.removeClass("file-uploading"), u.removeClass("disabled " + l).addClass(s), d();
          }, i._mergeAjaxCallback("beforeSend", r, "delete"), i._mergeAjaxCallback("success", o, "delete"), i._mergeAjaxCallback("error", c, "delete"), m = e.extend(!0, {}, { url: p, type: "POST", dataType: "json", data: e.extend(!0, {}, { key: f }, h) }, i.ajaxDeleteSettings), i._handler(u, "click", function () {
      ...
      var i,
          ...
          r = this,
          o = parseFloat(t),
          l = r.fileSizeGetter;return e.isNumeric(t) && e.isNumeric(o) ? ("function" == typeof l ? n = l(o) : 0 === o ? n = "0.00 B" : (i = Math.floor(Math.log(o) / Math.log(1024)), a = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], n = 1 * (o / Math.pow(1024, i)).toFixed(2) + " " + a[i]), r._getLayoutTemplate("size").replace("{sizeText}", n)) : "";
    }, _generatePreviewTemplate: function _generatePreviewTemplate(i, a, n, r, o, l, s, d, c, u, p) {
      var f,
          m,
          v = this,
          g = v.slug(n),
          ...
          x = "type-default",
          E = y && v.preferIconicPreview,
          T = y && v.preferIconicZoomPreview;return b && e.each(b, function (e, t) {
        w += e + ":" + t + ";";
      }), m = function m(a, l, s, c) {
        var f = s ? "zoom-" + o : o,
            m = v._getPreviewTemplate(a),
            h = (d || "") + " " + c;return v.frameClass && (h = v.frameClass + " " + h), s && (h = h.replace(" " + t.SORT_CSS, "")), m = v._parseFilePreviewIcon(m, n), "text" === a && (l = t.htmlEncode(l)), "object" !== i || r || e.each(v.defaults.fileTypeSettings, function (e, t) {
          "object" !== e && "other" !== e && t(n, r) && (x = "type-" + e);
        }), m.setTokens({ previewId: f, caption: g, frameClass: h, type: r, fileindex: u, typeCss: x, footer: C, data: l, template: p || i, style: w ? 'style="' + w + '"' : "" });
      }, u = u || o.slice(o.lastIndexOf("-") + 1), v.fileActionSettings.showZoom && (h = m(T ? "other" : i, a, !0, "kv-zoom-thumb")), h = "\n" + v._getLayoutTemplate("zoomCache").replace("{zoomContent}", h), f = m(E ? "other" : i, a, !1, "kv-preview-thumb"), f + h;
    }, _previewDefault: function _previewDefault(i, a, n) {
      var r = this,
        ...
        var l,
            ...
            f = t.objUrl.createObjectURL(i);r._clearDefaultPreview(), l = r._generatePreviewTemplate("other", f, s, d, a, p, c), o.append("\n" + l), r._setThumbAttr(a, u, c), n === !0 && r.isUploadable && r._setThumbStatus(e("#" + a), "Error");
      }
    }, _previewFile: function _previewFile(e, i, a, n, r) {
      if (this.showPreview) {
        var o,
            l = this,
            ...
            v = i.size || 0,
            g = i.type,
            h = "text" === s || "html" === s || "image" === s ? a.target.result : r,
            w = p && -1 !== p.indexOf(g);if ("html" === s && l.purifyHtml && window.DOMPurify && (h = window.DOMPurify.sanitize(h)), m || w) {
          o = l._generatePreviewTemplate(s, h, d, g, n, !1, v), l._clearDefaultPreview(), f.append("\n" + o);var _ = f.find("#" + n + " img");_.length && l.autoOrientImage ? t.validateOrientation(i, function (e) {
            if (!e) return void l._validateImage(n, c, g, v, h);var a = f.find("#zoom-" + n + " img"),
                r = "rotate-" + e;e > 4 && (r += _.width() > _.height() ? " is-portrait-gt4" : " is-landscape-gt4"), t.addCss(_, r), t.addCss(a, r), l._raise("fileimageoriented", { $img: _, file: i }), l._validateImage(n, c, g, v, h), t.adjustOrientedImage(_);
          }) : l._validateImage(n, c, g, v, h);
        } else l._previewDefault(i, n);l._setThumbAttr(n, c, v), l._initSortable();
      }
      ...
      var e,
          ...
          l = r.previewCache.count();if (0 !== l) for (var s = 0; l > s; s++) {
        e = o.config[s], n = r.previewInitId + "-init_" + s, i = t.ifSet("caption", e, t.ifSet("filename", e)), a = t.ifSet("size", e), r._setThumbAttr(n, i, a);
      }
    }, _slugDefault: function _slugDefault(e) {
      return t.isEmpty(e) ? "" : String(e).replace(/[\-\[\]\/\{}:;#%=\(\)\*\+\?\\\^\$\|<>&"']/g, "_");
    }, _readFiles: function _readFiles(i) {
      this.reader = new FileReader();var _a2,
          ...
          y = function y(t, r, o, l) {
        var s,
            d = e.extend(!0, {}, n._getOutData({}, {}, i), { id: o, index: l }),
            c = { id: o, index: l, file: r, files: i };return n._previewDefault(r, o, !0), n.isUploadable && (n.addToStack(void 0), setTimeout(function () {
          _a2(l + 1);
        }, 100)), n._initFileActions(), s = e("#" + o), s.find(".kv-file-upload").hide(), n.removeFromPreviewOnError && s.remove(), n.isUploadable ? n._showUploadError(t, d) : n._showError(t, c);
      };n.loadedImages = [], n.totalImagesCount = 0, e.each(i, function (e, t) {
        var i = n.fileTypeSettings.image;i && i(t.type) && n.totalImagesCount++;
      }), _a2 = function a(e) {
        if (t.isEmpty(r.attr("multiple")) && (f = 1), e >= f) return n.isUploadable && n.filestack.length > 0 ? n._raise("filebatchselected", [n.getFileStack()]) : n._raise("filebatchselected", [i]), s.removeClass("file-thumb-loading"), void d.html("");var x,
            E,
            T,
            S,
            F,
            ...
            B = (U.size || 0) / 1e3,
            R = "",
            O = t.objUrl.createObjectURL(U),
            L = 0,
            Z = "";if (h > 0) for (S = 0; h > S; S++) {
          P = g[S], A = n.msgFileTypes[P] || P, Z += 0 === S ? A : ", " + A;
        }if (j === !1) return void _a2(e + 1);if (0 === j.length) return F = n.msgInvalidFileName.replace("{name}", t.htmlEncode(U.name)), void (n.isError = y(F, U, $, e));if (t.isEmpty(w) || (R = new RegExp("\\.(" + w.join("|") + ")$", "i")), T = B.toFixed(2), n.maxFileSize > 0 && B > n.maxFileSize) return F = n.msgSizeTooLarge.setTokens({ name: j, size: T, maxSize: n.maxFileSize }), void (n.isError = y(F, U, $, e));if (null !== n.minFileSize && B <= t.getNum(n.minFileSize)) return F = n.msgSizeTooSmall.setTokens({ name: j, size: T, minSize: n.minFileSize }), void (n.isError = y(F, U, $, e));if (!t.isEmpty(g) && t.isArray(g)) {
          for (S = 0; S < g.length; S += 1) {
            k = g[S], z = m[k], L += z && "function" == typeof z && z(U.type, U.name) ? 1 : 0;
          }if (0 === L) return F = n.msgInvalidFileType.setTokens({ name: j, types: Z }), void (n.isError = y(F, U, $, e));
        }return 0 !== L || t.isEmpty(w) || !t.isArray(w) || t.isEmpty(R) || (I = t.compare(j, R), L += t.isEmpty(I) ? 0 : I.length, 0 !== L) ? n.showPreview ? !C && B > b ? (n.addToStack(U), s.addClass("file-thumb-loading"), n._previewDefault(U, $), n._initFileActions(), n._updateFileDetails(f), void _a2(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
          n._errorHandler(e, j);
        }, l.onload = function (t) {
          n._previewFile(e, U, t, $, O), n._initFileActions();
        }, l.onloadend = function () {
          F = u.setTokens({ index: e + 1, files: f, percent: 50, name: j }), setTimeout(function () {
            d.html(F), n._updateFileDetails(f), _a2(e + 1);
          }, 100), n._raise("fileloaded", [U, $, e, l]);
        }, l.onprogress = function (t) {
          if (t.lengthComputable) {
            var i = t.loaded / t.total * 100,
                a = Math.ceil(i);F = u.setTokens({ index: e + 1, files: f, percent: a, name: j }), setTimeout(function () {
              d.html(F);
            }, 100);
          }
        }, x = m.text, E = m.image, x(U.type, j) ? l.readAsText(U, n.textEncoding) : E(U.type, j) ? l.readAsDataURL(U) : l.readAsArrayBuffer(U)) : (n._previewDefault(U, $), setTimeout(function () {
          _a2(e + 1), n._updateFileDetails(f);
        }, 100), n._raise("fileloaded", [U, $, e, l])), void n.addToStack(U)) : (n.isUploadable && n.addToStack(U), setTimeout(function () {
          _a2(e + 1), n._updateFileDetails(f);
        }, 100), void n._raise("fileloaded", [U, $, e, l])) : (F = n.msgInvalidFileExtension.setTokens({ name: j, extensions: _ }), void (n.isError = y(F, U, $, e)));
      ...
      var i = this,
          ...
          o = i.slug(r),
          l = i.isUploadable ? n.length : e,
          s = i.previewCache.count() + l,
          d = l > 1 ? i._getMsgSelected(s) : o;i.isError ? (i.$previewContainer.removeClass("file-thumb-loading"), i.$previewStatus.html(""), i.$captionContainer.find(".kv-caption-icon").hide()) : i._showFileIcon(), i._setCaption(d, i.isError), i.$container.removeClass("file-input-new file-input-ajax-new"), 1 === arguments.length && i._raise("fileselect", [e, o]), i.previewCache.count() && i._initPreviewActions();
      ...
      var i = this;if (i.showPreview) {
        var a = "indicator" + t,
            ...
            l = i.fileActionSettings;e.removeClass("file-preview-success file-preview-error file-preview-loading"), "Success" === t && e.find(".file-drag-handle").remove(), o.html(l[a]), o.attr("title", l[n]), e.addClass(r), "Error" !== t || i.retryErrorUploads || e.find(".kv-file-upload").attr("disabled", !0);
      }
      ...
      var n,
          ...
          d = 100 > o ? r.progressTemplate : a ? r.progressErrorTemplate : s;i = i || r.$progress, t.isEmpty(d) || (n = l && o > l && 100 >= e ? d.setTokens({ percent: l, status: r.msgUploadThreshold }) : d.setTokens({ percent: o, status: e > 100 ? r.msgUploadEnd : o + "%" }), i.html(n), a && i.find('[role="progressbar"]').html(a));
    }, _setFileDropZoneTitle: function _setFileDropZoneTitle() {
      var e,
          i = this,
          a = i.$container.find(".file-drop-zone"),
          n = i.dropZoneTitle;i.isClickable && (e = t.isEmpty(i.$element.attr("multiple")) ? i.fileSingle : i.filePlural, n += i.dropZoneClickTitle.replace("{files}", e)), a.find("." + i.dropZoneTitleClass).remove(), i.isUploadable && i.showPreview && 0 !== a.length && !(i.getFileStack().length > 0) && i.dropZoneEnabled && (0 === a.find(t.FRAMES).length && t.isEmpty(i.defaultPreviewContent) && a.prepend('<div class="' + i.dropZoneTitleClass + '">' + n + "</div>"), i.$container.removeClass("file-input-new"), t.addCss(i.$container, "file-input-ajax-new"));
      ...
      var n = this;return void 0 !== t && n.updateStack(t, i), n.removeFromPreviewOnError && !a ? void e.remove() : (n._setThumbStatus(e, "Error"), void n._refreshUploadButton(e, a));
    ...
    }, _checkDimensions: function _checkDimensions(e, i, a, n, r, o, l) {
      var s,
          d,
          c,
          u,
          p = this,
          f = "Small" === i ? "min" : "max",
          m = p[f + "Image" + o];!t.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === i ? d >= m : m >= d, u || (s = p["msgImage" + o + i].setTokens({ name: r, size: m }), p._showUploadError(s, l), p._setPreviewError(n, e, null)));
    }, _validateImage: function _validateImage(t, i, a, n, r) {
      var o,
          l,
          s,
          d,
          ...
          m = p.find("img");i = i || "Untitled", m.one("load", function () {
        l = p.width(), s = u.width(), l > s && m.css("width", "100%"), o = { ind: f, id: t }, c._checkDimensions(f, "Small", m, p, i, "Width", o), c._checkDimensions(f, "Small", m, p, i, "Height", o), c.resizeImage || (c._checkDimensions(f, "Large", m, p, i, "Width", o), c._checkDimensions(f, "Large", m, p, i, "Height", o)), c._raise("fileimageloaded", [t]), d = window.piexif ? window.piexif.load(r) : null, c.loadedImages.push({ ind: f, img: m, thumb: p, pid: t, typ: a, siz: n, validated: !1, imgData: r, exifObj: d }), p.data("exif", d), c._validateAllImages();
      }).one("error", function () {
      ...
      var e,
        ...
        t = a.loadedImages[e], t.validated || (i = t.siz, i && i > 1e3 * o && a._getResizedImage(t, n, r), a.loadedImages[e].validated = !0);
      }
    }, _getResizedImage: function _getResizedImage(i, a, n) {
      var r,
          o,
          l,
          s,
        ...
        p.isUploadable ? p._showUploadError(e, t, i) : p._showError(e, t, i), p._setPreviewError(T, E);
      }, (!p.filestack[E] || !_ || h >= m && w >= v) && (_ && p.filestack[E] && p._raise("fileimageresized", [x, E]), a.val++, a.val === n && p._raise("fileimagesresized"), !_)) return void d(p.msgImageResizeError, { id: x, index: E }, "fileimageresizeerror");y = y || p.resizeDefaultImageType, o = m > h, l = v > w, g = "width" === p.resizePreference ? o ? h / m : l ? w / v : 1 : l ? w / v : o ? h / m : 1, p._resetCanvas(), m *= g, v *= g, b.width = m, b.height = v;try {
        C.drawImage(f, 0, 0, m, v), s = b.toDataURL(y, p.resizeQuality), S && (u = window.piexif.dump(S), s = window.piexif.insert(u, s)), r = t.dataURI2Blob(s), p.filestack[E] = r, p._raise("fileimageresized", [x, E]), a.val++, a.val === n && p._raise("fileimagesresized", [void 0, void 0]), r instanceof Blob || d(p.msgImageResizeError, { id: x, index: E }, "fileimageresizeerror");
      } catch (F) {
        a.val++, a.val === n && p._raise("fileimagesresized", [void 0, void 0]), c = p.msgImageResizeException.replace("{errors}", F.message), d(c, { id: x, index: E }, "fileimageresizeexception");
      }
      ...
      var e = this,
          i = e.initialCaption || "";return e.overwriteInitial || t.isEmpty(i) ? (e.$caption.html(""), !1) : (e._setCaption(i), !0);
      ...
      var n,
        ...
        if (a) n = e("<div>" + s.msgValidationError + "</div>").text(), o = d.length, l = o ? 1 === o && d[0] ? s._getFileNames()[0] : s._getMsgSelected(o) : s._getMsgSelected(s.msgNo), r = '<span class="' + s.msgValidationErrorClass + '">' + s.msgValidationErrorIcon + (t.isEmpty(i) ? l : i) + "</span>";else {
          if (t.isEmpty(i)) return;n = e("<div>" + i + "</div>").text(), r = s._getLayoutTemplate("fileIcon") + n;
      ...
      var i = this,
          ...
          if (!i.showCancel) return "";n += " kv-hidden";break;case "upload":
          if (!i.showUpload) return "";i.isUploadable && !i.isDisabled ? a = i._getLayoutTemplate("btnLink").replace("{href}", i.uploadUrl) : d = "submit";break;case "browse":
          if (!i.showBrowse) return "";a = i._getLayoutTemplate("btnBrowse");break;default:
          return "";}return n += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", t.isEmpty(l) || (l = ' <span class="' + i.buttonLabelClass + '">' + l + "</span>"), a.setTokens({ type: d, css: n, title: r, status: s, icon: o, label: l });
    ...
    }, _renderFileFooter: function _renderFileFooter(e, i, a, n) {
      var r,
          o = this,
          ...
          g = f.setTokens({ indicator: m, indicatorTitle: v });return i = o._getSize(i), r = o.isUploadable ? p.setTokens({ actions: o._renderFileActions(c, !1, s, u, d, !1, !1, !1), caption: e, size: i, width: a, progress: o._renderThumbProgress(), indicator: g }) : p.setTokens({ actions: o._renderFileActions(!1, !1, !1, u, d, !1, !1, !1), caption: e, size: i, width: a, progress: "", indicator: g }), r = t.replaceTags(r, o.previewThumbTags);
    }, _renderFileActions: function _renderFileActions(e, t, i, a, n, r, o, l, s, d, c) {
      if (!(e || t || i || a || n)) return "";var u,
          p = this,
          f = o === !1 ? "" : ' data-url="' + o + '"',
          m = l === !1 ? "" : ' data-key="' + l + '"',
          v = "",
          ...
          x = r ? C.removeClass + " disabled" : C.removeClass;return i && (v = p._getLayoutTemplate("actionDelete").setTokens({ removeClass: x, removeIcon: C.removeIcon, removeTitle: C.removeTitle, dataUrl: f, dataKey: m, key: l })), e && (g = p._getLayoutTemplate("actionUpload").setTokens({ uploadClass: C.uploadClass, uploadIcon: C.uploadIcon, uploadTitle: C.uploadTitle })), t && (h = p._getLayoutTemplate("actionDownload").setTokens({ downloadClass: C.downloadClass, downloadIcon: C.downloadIcon, downloadTitle: C.downloadTitle, downloadUrl: d || p.initialPreviewDownloadUrl }), h = h.setTokens({ filename: c, key: l })), a && (w = p._getLayoutTemplate("actionZoom").setTokens({ zoomClass: C.zoomClass, zoomIcon: C.zoomIcon, zoomTitle: C.zoomTitle })), n && s && (u = "drag-handle-init " + C.dragClass, _ = p._getLayoutTemplate("actionDrag").setTokens({ dragClass: u, dragTitle: C.dragTitle, dragIcon: C.dragIcon })), b.setTokens({ "delete": v, upload: g, download: h, zoom: w, drag: _, other: y });
      ...
      var a = this,
          n = a.$element;if (!a.isUploadable && t.isEmpty(n.val()) && a.fileInputCleared) return void (a.fileInputCleared = !1);a.fileInputCleared = !1;var r,
          o,
          l,
          s,
          d = [],
          ...
          g = 0,
          h = a._getFileIds(),
          w = function w(t, i, n, r) {
        var o = e.extend(!0, {}, a._getOutData({}, {}, p), { id: n, index: r }),
            l = { id: n, index: r, file: i, files: p };return a.isUploadable ? a._showUploadError(t, o) : a._showError(t, l);
      };if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c ? e.each(p, function (e, t) {
      ...
      }) : d = p), t.isEmpty(d) || 0 === d.length) return u || a.clear(), a._showFolderError(g), void a._raise("fileselectnone");if (a._resetErrors(), s = d.length, o = a._getFileCount(a.isUploadable ? a.getFileStack().length + s : s), a.maxFileCount > 0 && o > a.maxFileCount) {
      ...
      } else !u || v ? (a._resetPreviewThumbs(!1), v && a.clearStack()) : !u || 0 !== f || a.previewCache.count() && !a.overwriteInitial || a._resetPreviewThumbs(!0);a.isPreviewable ? a._readFiles(d) : a._updateFileDetails(1), a._showFolderError(g);
    }, _abort: function _abort(t) {
      var i,
          a = this;return a.ajaxAborted && "object" == _typeof(a.ajaxAborted) && void 0 !== a.ajaxAborted.message ? (i = e.extend(!0, {}, a._getOutData(), t), i.abortData = a.ajaxAborted.data || {}, i.abortMessage = a.ajaxAborted.message, a._setProgress(101, a.$progress, a.msgCancelled), a._showUploadError(a.ajaxAborted.message, i, "filecustomerror"), a.cancel(), !0) : !1;
      ...
      var i = this,
        ...
        var l,
            ...
            c = i.filestack[d],
            u = s.attr("id");"-1" !== d && -1 !== d && (void 0 !== c ? (n[a] = c, r[a] = i._getFileName(c), o[a] = i._getFileId(c), s.attr({ id: i.previewInitId + "-" + a, "data-fileindex": a }), a++) : (l = "uploaded-" + t.uniqId(), s.attr({ id: l, "data-fileindex": "-1" }), i.$preview.find("#zoom-" + u).attr("id", "zoom-" + l)));
      ...
      var e = this,
          t = e.isUploadable ? e.getFileStack().length : e.$element.get(0).files.length;return e._getFileCount(t);
    }, lock: function lock() {
      ...
      var e = this;if (e._raise("filereset")) return e._resetPreview(), e.$container.find(".fileinput-filename").text(""), t.addCss(e.$container, "file-input-new"), (e.getFrames().length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"), e.clearStack(), e.formdata = {}, e._setFileDropZoneTitle(), e.$element;
      ...
      var i,
        ...
        if (r._resetUpload(), 0 === o && !l) return void r._showUploadError(r.msgUploadEmpty);if (r.$progress.show(), r.uploadCount = 0, r.uploadStatus = {}, r.uploadLog = [], r.lock(), r._setProgress(2), 0 === o && l) return void r._uploadExtraOnly();if (n = r.filestack.length, r.hasInitData = !1, !r.uploadAsync) return r._uploadBatch(), r.$element;for (a = r._getOutData(), r._raise("filebatchpreupload", [a]), r.fileBatchCompleted = !1, r.uploadCache = { content: [], config: [], tags: [], append: !0 }, r.uploadAsyncCount = r.getFileStack().length, i = 0; n > i; i++) {
          r.uploadCache.content[i] = null, r.uploadCache.config[i] = null, r.uploadCache.tags[i] = null;
        }for (r.$preview.find(".file-preview-initial").removeClass(t.SORT_CSS), r._initSortable(), r.cacheInitialPreview = r.getPreview(), i = 0; n > i; i++) {
      ...
      var t = this,
          ...
          a = t.$container,
          n = t.$element,
          r = t.namespace;return e(document).off(r), e(window).off(r), i && i.length && i.off(r), t.isUploadable && t._clearFileInput(), t._cleanup(), t._initPreviewCache(), n.insertBefore(a).off(r).removeData(), a.off().remove(), n;
    }, refresh: function refresh(i, a) {
      var n = this,
          r = n.$element;return i = "object" != (typeof i === "undefined" ? "undefined" : _typeof(i)) || t.isEmpty(i) ? n.options : e.extend(!0, {}, n.options, i), n._init(i, !0), n._listen(), a && r.trigger("change" + n.namespace), r;
      ...
      var i = this;return e = e || "", i.$preview.find(t.FRAMES + e);
