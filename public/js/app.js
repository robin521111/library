...
Vue.component('bookcard', __webpack_require__(37));
...
var table = new Vue({
  ...
  data: {
    ...
    gridData: [{ name: 'Bruce Lee', power: 9000 }, { name: 'Jackie Chen', power: 7000 }, { name: 'Jet Li', power: 8000 }]
...
Component.options.__file = "D:\\CodeForFun\\Homestead\\Code\\library\\resources\\assets\\js\\components\\BorrowCard.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] BorrowCard.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78b6b548", Component.options)
  } else {
    hotAPI.reload("data-v-78b6b548", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-78b6b548", module.exports)
  }
}
